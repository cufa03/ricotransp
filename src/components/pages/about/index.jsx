    ...
    <div className='about__container img__background'>
      ...
      <div className='about__description'>
        ...
        <p className='text__description'>
          En Transporte Rico Hnos, nuestra historia se basa en el compromiso con
          la excelencia y la satisfacción del cliente. Desde nuestros humildes
          comienzos como una empresa familiar, hemos crecido hasta convertirnos
          en un líder en el sector logístico. Nuestro equipo altamente
          capacitado y nuestras modernas flotas de transporte nos permiten
          ofrecer soluciones personalizadas y eficientes para cada uno de
          nuestros clientes. Nuestro enfoque es construir relaciones duraderas y
          ser reconocidos por nuestra calidad de servicio y profesionalismo en
          cada entrega.
        </p>
        ...
        <p className='text__description'>
          ...
          personalizado y soluciones a medida para tus necesidades específicas.
          Cuando eliges Transporte Rico Hnos, eliges un socio de confianza que
          te llevará al siguiente nivel en el mundo del transporte y la
          logística.
        </p>
